...
void test_merge_avl() {
	...
	merge_avl(&avlA, &avlB);
	printf("%s(%s): %d", "merge_avl", "avlA avlB", is_avl(avlA));
	printf("\n");
}

void test_merge_avlds() {
	printf("------------------\n");
	...
	merge_avlds(&avldsA, &avldsB);
	printf("%s(%s %s)-", "merge_avlds", "avldsA", "avldsB");
	printf("%s(%s): ", "display_stats", "avldsA");
	display_stats(&avldsA);
	printf("\n");
